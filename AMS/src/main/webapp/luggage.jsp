...
<body>
    ...
    <div class="hero-image-container">
        <img src="${pageContext.request.contextPath}/img/lugg.png" alt="laggage Service" class="hero-image">
    </div>
    ...
    <div class="content-container">
        ...
        <div class="service-description">
            Travel worry- and hands-free: All you have to do is collect your baggage on arrival at your destination.
            Alltheway is an Air France partner company that offers innovative services:
        </div>
        
        <ul class="service-features">
            <li>From Airport and the surrounding area, check in and drop off your baggage* before you reach the airport</li>
            <li>Personalized assistance throughout your airport experience</li>
            <li>Baggage delivery upon arrival at Airport</li>
        </ul>
    </div>
