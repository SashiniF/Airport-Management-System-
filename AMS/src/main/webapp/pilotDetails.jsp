...
<head>
    ...
    <title>Air Sri Lanka - Pilot Registration</title>
    <style>
        body {
            ...
            padding: 0;
            color: #333;
            background-image: url('img/pilotBG.png');
...
<body>
    ...
    <div class="container">
        <h1 class="title">Pilot Registration</h1>
        <form action="registerPilot.jsp" method="post">
            <div class="form-group">
                <label for="pilotID">Pilot ID</label>
                <input type="text" id="pilotID" name="pilotID" value="PILOT001" readonly>
            </div>
