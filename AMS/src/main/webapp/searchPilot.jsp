...
<body>
    ...
    <div class="search-form">
        <form method="get" action="searchPilot.jsp">
            <input type="text" name="searchQuery" class="search-input" placeholder="Enter Pilot ID or License Number" required>
    ...
    <%
        ...
        try {
            ...
            if (searchQuery != null && !searchQuery.isEmpty()) {
                String sql = "SELECT pilotID, pilotName, licenseNumber, email, phone, flightNumber FROM pilots WHERE pilotID LIKE ? OR licenseNumber LIKE ?";
